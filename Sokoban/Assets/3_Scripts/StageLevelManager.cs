...
public class StageLevelManager : MonoBehaviour {
    ...
    public class StageInfo {
        ...
        [XmlElement("cells")] public StageCell[] cells;
    ...
    public struct StageCell {
        ...
        [XmlElement("type")] public StageCellType type;
    ...
    public List<StageEditTile> stageTiles;
    ...
    void SetTilePosition(GameObject tileObj, int x, int z) {
        Vector3 newPos = new Vector3(x, 0f, -z);
        Vector3 correction = new Vector3(stageSize * 0.5f, 0f, -(stageSize * 0.5f));
        tileObj.transform.localPosition = newPos - correction - new Vector3(-0.5f, 0f, 0.5f);
    }
}